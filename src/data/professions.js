var PROFS=[{id:"none",name:"— Нет —",ab:"",abN:"",pS:[],pSk:[]},{id:"merchant",name:"Купец",ab:"+5 Убеждение/день",abN:"Мастер Обмена",pS:["EMP","INT"],pSk:["Убеждение","Обман","Уличные знания","Азартные игры","Верховая езда"]},{id:"warrior",name:"Воин",ab:"+5 атака/день",abN:"Стойкость",pS:["REF","BODY"],pSk:["Боевое оружие","Сопротивление","Атлетика","Уклонение","Простое оружие"]},{id:"priest",name:"Священник",ab:"Воля Судьбы",abN:"Воля Судьбы",pS:["WILL","EMP"],pSk:["Чародейство","Выступление","Знания","Сопротивление магии","Убеждение"]},{id:"artisan",name:"Ремесленник",ab:"Оценка механизмов",abN:"Рука Мастера",pS:["CRA","INT"],pSk:["Кузнечное дело","Механика","Алхимия","Расследование","Знания"]},{id:"sensitive",name:"Чудотворец",ab:"+1d6 урона",abN:"Хаот. Всплеск",pS:["WILL","EMP"],pSk:["Чародейство","Сопротивление магии","Внимательность","Знания","Выступление"]}];
var PROF_DESC={
