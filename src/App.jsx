...
return(<div style={{fontFamily:"'Inter',sans-serif",color:"#e9e9ed",background:"linear-gradient(180deg,#161826,#0e0f18)",minHeight:"100vh",maxWidth:520,margin:"0 auto",display:"flex",flexDirection:"column"}}><style>{CSS}</style>
...
<div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"5px 10px",background:"#1b1813",color:"#e9e9ed",fontSize:10,gap:4}}><span style={{fontFamily:"'Inter',sans-serif",fontWeight:700}}>✦ Nox Aeterna <span style={{fontSize:7,opacity:0.5,fontWeight:400}}>v2.0</span></span><div style={{display:"flex",gap:4,alignItems:"center"}}><button onClick={function(){sShowDonate(true)}} style={{background:"linear-gradient(90deg,#f59e0b,#d97706)",border:"none",borderRadius:4,padding:"2px 8px",color:"#e9e9ed",cursor:"pointer",fontSize:9,fontFamily:"'Inter',sans-serif",fontWeight:700}}>💰 Донат</button><span style={{border:"1px solid #34374a",borderRadius:4,padding:"2px 8px",color:"#e9e9ed",fontSize:10,fontFamily:"'Inter',sans-serif"}}>{(isGM?"🎭 ":"👤 ")+auth.login}</span><button onClick={leave} style={{background:"none",border:"none",color:"#ef4444",cursor:"pointer",fontSize:10}}>Выйти</button></div></div>
