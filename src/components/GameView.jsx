...
import { IconBattle, IconChar, IconChat, IconInv, IconLib, IconScroll } from '../icons/index';
...
var tabs=[{id:"chat",l:"Чат",ic:<IconChat/>},{id:"character",l:"Профиль",ic:<IconChar/>},{id:"combat",l:"Бой",ic:<IconBattle/>},{id:"inventory",l:"Инв.",ic:<IconInv/>},{id:"library",l:"Лор",ic:<IconLib/>},{id:"guide",l:"Памятка",ic:<IconScroll/>}];
...
{tab==="chat"&&<ChatTab chat={pr.chat} logs={pr.logs} sendChat={pr.sendChat} addLog={pr.addLog} char={isGMv?null:c} characters={pr.characters} who={isGMv?"Мастер":(c.name||"???")}/>}
...
<PartyRail characters={pr.characters} selfId={c._fbId}/>
</div>)}
