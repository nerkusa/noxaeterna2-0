...
import { IconBattle, IconChar, IconChat, IconInv, IconLib, IconParty, IconScroll } from '../icons/index';
...
var tabs=[{id:"chat",l:"Чат",ic:<IconChat/>},{id:"character",l:"Профиль",ic:<IconChar/>},{id:"combat",l:"Бой",ic:<IconBattle/>},{id:"inventory",l:"Инв.",ic:<IconInv/>},{id:"party",l:"Группа",ic:<IconParty/>},{id:"library",l:"Лор",ic:<IconLib/>},{id:"guide",l:"Памятка",ic:<IconScroll/>}];
