    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      ...
      <div style={card}>
        ...
        <div style={{ fontSize: 10, color: '#b2b6ca', lineHeight: 1.6 }}>
          ...
          • <b>Если проиграл игрок</b> — выбор: <b>«Пересилить»</b> (−2 Воли, бесплатно на HP &lt;25% с чертой «Хладнокровие») снимает эффект полностью; <b>«Поддаться»</b> (−2/3 Воли) — при проигрыше на 1–4 даёт ещё и «Потрясён» (−2 к следующему броску), при проигрыше на 5+ или собственном d10=1 — «Сломлен» (пропуск хода/отступление в этот раунд).<br />
