...
function cF(c){var R=getRaces();var rc=R.find(function(r){return r.id===c.raceId})||R[0];var baseStats=Object.assign({},iS(),c.stats||{});var es=gE(baseStats,rc.st);if(rc.fp&&c.humanBonusStat)es[c.humanBonusStat]=(es[c.humanBonusStat]||0)+1;return{race:rc,fs:es,eSk:gE(c.skills||iSk(),rc.sk)}}function mHP(f){return((f.BODY||0)+(f.WILL||0))*2}
function nC(name){return{name:name||"",level:1,xp:0,profId:"none",raceId:"none",humanBonusStat:"",portrait:"",hair:"",height:"",weight:"",alignment:"",eyeColor:"",skinColor:"",bio:"",lifepath:[],stats:iS(),skills:iSk(),locked:false,curHp:null,hpOv:null,curWill:null,willOv:null,weapons:[],lvlPts:0,spentLvlPts:0,armors:[],equippedHead:null,equippedBody:null,shield:null,shieldHp:0,shieldMaxHp:0,equippedWeapon:null,weaponMode:"1h",inventory:[],currency:{gold:0,silver:0,bronze:0,copper:0}}}
